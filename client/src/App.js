...
function App() {
  ...
  return (
    <div className="App">
      <MetaTags>
        <title> Red-DSL </title>
        <meta name="description" content="ReD-DSL Open Beta Chatbot." />
      </MetaTags>
      <Fade bottom cascade>
        <h1>ReD-DSL Open Beta</h1>
        <h2>Start chatting with the Test-Chatbot Button!</h2>
        <h3>Try telling the bot 'call' after logged in</h3>
      </Fade>
      <TypedReact />
      {showBot && (
        <Fade big>
